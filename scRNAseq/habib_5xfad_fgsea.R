...
for (i in 1:length(cells.list)) {
	...
	setwd("/work/biernaskie_lab/apun/nilesh_glut1/human_AD/5xfad/deg")
	filename <- paste0("5xFAD_",cells.list[i],"_markers_fem.gsea.csv")		
