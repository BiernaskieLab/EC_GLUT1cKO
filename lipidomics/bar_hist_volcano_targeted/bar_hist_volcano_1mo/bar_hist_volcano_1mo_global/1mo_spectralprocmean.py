...
# load ventricle data
ventricle_162 = pd.read_csv('286-ventricle.csv', delimiter=';')
ventricle_163 = pd.read_csv('287-ventricle.csv', delimiter=';')
ventricle_164 = pd.read_csv('288-ventricle.csv', delimiter=';')
ventricle_292 = pd.read_csv('509-ventricle.csv', delimiter=';')
ventricle_271 = pd.read_csv('521-ventricle.csv', delimiter=';')
ventricle_272 = pd.read_csv('522-ventricle.csv', delimiter=';')
# load cortex data
cortex_162 = pd.read_csv('286-cortex.csv', delimiter=';')
cortex_163 = pd.read_csv('287-cortex.csv', delimiter=';')
cortex_164 = pd.read_csv('288-cortex.csv', delimiter=';')
cortex_292 = pd.read_csv('509-cortex.csv', delimiter=';')
cortex_271 = pd.read_csv('521-cortex.csv', delimiter=';')
cortex_272 = pd.read_csv('522-cortex.csv', delimiter=';')
# load caudate data
caudate_162 = pd.read_csv('286-caudate.csv', delimiter=';')
caudate_163 = pd.read_csv('287-caudate.csv', delimiter=';')
caudate_164 = pd.read_csv('288-caudate.csv', delimiter=';')
caudate_292 = pd.read_csv('509-caudate.csv', delimiter=';')
caudate_271 = pd.read_csv('521-caudate.csv', delimiter=';')
caudate_272 = pd.read_csv('522-caudate.csv', delimiter=';')
# load ventral data
ventral_162 = pd.read_csv('286-ventral.csv', delimiter=';')
ventral_163 = pd.read_csv('287-ventral.csv', delimiter=';')
ventral_164 = pd.read_csv('288-ventral.csv', delimiter=';')
ventral_292 = pd.read_csv('509-ventral.csv', delimiter=';')
ventral_271 = pd.read_csv('521-ventral.csv', delimiter=';')
ventral_272 = pd.read_csv('522-ventral.csv', delimiter=';')
# load corpus data
corpus_162 = pd.read_csv('286-corpus.csv', delimiter=';')
corpus_163 = pd.read_csv('287-corpus.csv', delimiter=';')
corpus_164 = pd.read_csv('288-corpus.csv', delimiter=';')
corpus_292 = pd.read_csv('509-corpus.csv', delimiter=';')
corpus_271 = pd.read_csv('521-corpus.csv', delimiter=';')
corpus_272 = pd.read_csv('522-corpus.csv', delimiter=';')
# load caudate+cortex data
cc_162 = pd.read_csv('286-cc.csv', delimiter=';')
cc_163 = pd.read_csv('287-cc.csv', delimiter=';')
cc_164 = pd.read_csv('288-cc.csv', delimiter=';')
cc_292 = pd.read_csv('509-cc.csv', delimiter=';')
cc_271 = pd.read_csv('521-cc.csv', delimiter=';')
cc_272 = pd.read_csv('522-cc.csv', delimiter=';')
...
mean_ko = np.concatenate([mean_272, mean_292, mean_271])

def statistic(x,y,axis):
    return np.mean(x, axis=axis)-np.mean(y, axis=axis)

res = stats.permutation_test((mean_ko, mean_ctrl), statistic, batch=len(mean_ctrl)-1, vectorized=True, permutation_type='independent', n_resamples=1e4, alternative='greater')
print(res.statistic, res.pvalue)
u_stat, u_p = stats.mannwhitneyu(x=mean_ctrl, y=mean_ko, alternative='less')
