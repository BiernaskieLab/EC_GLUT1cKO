...
ratio = 8
drift = [(184481-64005)/ratio, (814958-845483)/ratio, (227757-94219)/ratio]
...
# k=2
# mean_162 = (split(ventricle_162.iloc[i,:], k))+drift[i]
...
# k=2
# mean_162 = (split(cortex_162.iloc[i,:], k))#+drift[i]
