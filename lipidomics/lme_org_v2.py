...
# load ventricle data
ventricle_c1 = pd.read_csv('ion_counts/162-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_c2 = pd.read_csv('ion_counts/163-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_c3 = pd.read_csv('ion_counts/164-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_c4 = pd.read_csv('ion_counts/565-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko1 = pd.read_csv('ion_counts/ventricle-271-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko2 = pd.read_csv('ion_counts/272-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko3 = pd.read_csv('ion_counts/292-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko4 = pd.read_csv('ion_counts/373-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
# load cortex data
cortex_c1 = pd.read_csv('ion_counts/162-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_c2 = pd.read_csv('ion_counts/163-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_c3 = pd.read_csv('ion_counts/164-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_c4 = pd.read_csv('ion_counts/565-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko1 = pd.read_csv('ion_counts/cortex-271-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko2 = pd.read_csv('ion_counts/272-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko3 = pd.read_csv('ion_counts/292-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko4 = pd.read_csv('ion_counts/373-cortex-Total Ion Count.csv', delimiter=';', comment='#')
# load corpus data
corpus_c1 = pd.read_csv('ion_counts/162-corpus-callosum-Total Ion Count.csv', delimiter=';', comment='#')
corpus_c2 = pd.read_csv('ion_counts/163-corpus-callosum-Total Ion Count.csv', delimiter=';', comment='#')
corpus_c3 = pd.read_csv('ion_counts/164-corpus-callosum-Total Ion Count.csv', delimiter=';', comment='#')
corpus_c4 = pd.read_csv('ion_counts/565-corpus-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko1 = pd.read_csv('ion_counts/ion_counts/corpus-271-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko2 = pd.read_csv('ion_counts/272-corpus-callosum-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko3 = pd.read_csv('ion_counts/292-corpus-callosum-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko4 = pd.read_csv('ion_counts/373-corpus-Total Ion Count.csv', delimiter=';', comment='#')


# load ventricle data
ventricle_c1y = pd.read_csv('ion_counts/286-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_c2y = pd.read_csv('ion_counts/287-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_c3y = pd.read_csv('ion_counts/288-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko1y = pd.read_csv('ion_counts/509-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko2y = pd.read_csv('ion_counts/521-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
ventricle_ko3y = pd.read_csv('ion_counts/522-ventricle-Total Ion Count.csv', delimiter=';', comment='#')
# load cortex data
cortex_c1y = pd.read_csv('ion_counts/286-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_c2y = pd.read_csv('ion_counts/287-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_c3y = pd.read_csv('ion_counts/288-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko1y = pd.read_csv('ion_counts/509-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko2y = pd.read_csv('ion_counts/521-cortex-Total Ion Count.csv', delimiter=';', comment='#')
cortex_ko3y = pd.read_csv('ion_counts/522-cortex-Total Ion Count.csv', delimiter=';', comment='#')
# load corpus data
corpus_c1y = pd.read_csv('ion_counts/286-corpus-Total Ion Count.csv', delimiter=';', comment='#')
corpus_c2y = pd.read_csv('ion_counts/287-corpus-Total Ion Count.csv', delimiter=';', comment='#')
corpus_c3y = pd.read_csv('ion_counts/288-corpus-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko1y = pd.read_csv('ion_counts/509-corpus-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko2y = pd.read_csv('ion_counts/521-corpus-Total Ion Count.csv', delimiter=';', comment='#')
corpus_ko3y = pd.read_csv('ion_counts/522-corpus-Total Ion Count.csv', delimiter=';', comment='#')
