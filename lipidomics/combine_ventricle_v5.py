...
batches = [
    {
        'name': 'Batch 1',
        'WT': {
            '565': 'ion_counts/565-ventricle-Total Ion Count.csv',
        },
        'KO': {
            '271': 'ion_counts/ventricle-271-Total Ion Count.csv',
            '373': 'ion_counts/373-ventricle-Total Ion Count.csv',
        }
    },
    {
        'name': 'Batch 2',
        'WT': {
            '163': 'ion_counts/163-ventricle-Total Ion Count.csv',
            '164': 'ion_counts/164-ventricle-Total Ion Count.csv',
            '162': 'ion_counts/162-ventricle-Total Ion Count.csv',
        },
        'KO': {
            '272': 'ion_counts/272-ventricle-Total Ion Count.csv',
            '292': 'ion_counts/292-ventricle-Total Ion Count.csv',
        }
    }
]
