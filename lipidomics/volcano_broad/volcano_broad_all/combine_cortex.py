...
index_ref =  [0, cortex_c1.shape[1], cortex_c2.shape[1], cortex_c3.shape[1], cortex_c4.shape[1], \
              cortex_ko1.shape[1], cortex_ko2.shape[1], cortex_ko3.shape[1], cortex_ko4.shape[1]]

index_refy =  [0, cortex_c1y.shape[1], cortex_c2y.shape[1], cortex_c3y.shape[1], \
              cortex_ko1y.shape[1], cortex_ko2y.shape[1], cortex_ko3y.shape[1]]

# Ventricle
# Data Org (Tuple)
ventricle_all = [cortex_c1, cortex_c2, cortex_c3, cortex_c4, cortex_ko1, cortex_ko2, cortex_ko3, cortex_ko4]
ventricle_ally = [cortex_c1y, cortex_c2y, cortex_c3y, cortex_ko1y, cortex_ko2y, cortex_ko3y]

# As DataFrame
vent_all = pd.concat([cortex_c1, cortex_c2.iloc[:,1:], cortex_c3.iloc[:,1:], cortex_c3.iloc[:,1:], \
                       cortex_ko1.iloc[:,1:], cortex_ko2.iloc[:,1:], cortex_ko3.iloc[:,1:], \
                        cortex_ko4.iloc[:,1:]], axis=1)
vent_ally = pd.concat([cortex_c1y, cortex_c2y.iloc[:,1:], cortex_c3y.iloc[:,1:], \
